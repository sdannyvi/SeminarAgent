...
GNN: \textcolor{ForestGreen!70!black}{\textbf{operates on structure}} ✓
...
\begin{tikzpicture}[scale=0.85]
  ...
  \foreach \i/\lbl/\ht in {1/OptGNN/2.8, 2/IR/2.8, 3/Logit/2.9, 4/{L+C}/3.0} {
    \fill[bgucolor!60] ({0.5+(\i-1)*1.2}, 0) rectangle ({0.5+(\i-1)*1.2+0.9}, \ht);
